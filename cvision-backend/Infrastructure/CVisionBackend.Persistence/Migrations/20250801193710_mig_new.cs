        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestedKeywordsJson = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MissingSectionsJson = table.Column<string>(type: "text", nullable: false),
                    FormatIssuesJson = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CVAnalysisResults_CVFiles_CVFileId",
                        column: x => x.CVFileId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CVAnalysisResultId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeywordMatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KeywordMatches_CVAnalysisResults_CVAnalysisResultId",
                        column: x => x.CVAnalysisResultId,
                        principalTable: "CVAnalysisResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVAnalysisResults_CVFileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeywordMatches_CVAnalysisResultId",
                table: "KeywordMatches",
                column: "CVAnalysisResultId");
